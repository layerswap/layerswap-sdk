...
The REST API documentation can be found [on docs.layerswap.com](https://docs.Layerswap.com). The full API of this library can be found in [api.md](api.md).
...
const response = await layerswap.swaps.create().asResponse();
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/Layerswap-node/issues) with questions, bugs, or suggestions.
